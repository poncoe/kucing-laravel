...
<head>
    ...
    <!-- Title Web -->
    <title>Animolz : Informasi Jenis Kucing</title>
...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ route('tentang') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Tentang
                Kami</a>
            @endif
            @endauth
        </div>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <section id="artikel">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    @foreach($homey as $data)
                    <div class="col">
                        <div class="shadow p-3 mb-5 bg-white rounded">
                            <img src="/img/{{ $data->url_gambar }}" class="card-img-top" alt="gambar" height="350px" width="150px">
                            <div class="card-body">
                                <h5 class="card-title">{{ $data->judul}}</h5>
                                <p class="card-text text">{{ $data->deskripsi}}</p>
                                <a href="{{ route('homey.show',$data->id) }}" target="_blank" class="btn btn-success" role="button">Lihat
                                    Artikel</a>
                            </div>
                        </div>
                    </div>
